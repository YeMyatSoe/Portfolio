...
const ProjectCard = ({ proj, i }) => (
  ...
  >
    ...
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="text-teal-400 font-bold hover:text-teal-300 hover:underline flex items-center gap-2 transition text-sm sm:text-base"
    >
      Live Demo
      <svg
        className="w-4 h-4"
...
const SkillsGrid = ({ skills }) => (
  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 justify-items-center max-w-4xl mx-auto">
    {skills.map((skill, i) => (
...
const App = () => {
  ...
  const projects = [
    { title: "E-commerce App", description: "Flutter + Django backend + RESTful API", link: "https://stswm.com" },
    { title: "LMS Website", description: "Django + RESTful API + HTML/CSS + JavaScript", link: "https://ncapjtc.com" },
    { title: "Company Service Web", description: "JS + HTML/CSS + Bootstrap + Django + RESTful API", link: "https://ncabgm.com" },
  ];
    ...
    <div className="bg-slate-950 text-gray-200 min-h-screen font-sans">
      ...
      <ScrollSection id="hero" className="flex flex-col-reverse md:flex-row items-center justify-between p-6 sm:p-10 md:p-24 min-h-[85vh]">
        <div className="md:w-1/2 w-full mb-8 md:mb-0 md:pr-12 text-center md:text-left">
          ...
          <p className="text-xl sm:text-2xl md:text-3xl font-semibold text-teal-400 mb-6">I build modern web & mobile applications.</p>
          <p className="text-slate-400 text-base sm:text-lg mb-8 max-w-md sm:max-w-lg md:max-w-lg mx-auto md:mx-0">
            Full-Stack Developer skilled in Flutter, Python/Django, and modern development practices.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 mb-8 justify-center md:justify-start">
            <button onClick={() => scrollTo("projects")} className="w-full sm:w-auto bg-sky-500 text-slate-950 font-bold px-8 py-3 rounded-full shadow-lg shadow-sky-500/40 hover:bg-sky-400 transform hover:scale-105 transition duration-300 focus:ring-4 focus:ring-sky-500/70">
              View Projects
            </button>
            <button onClick={() => scrollTo("contact")} className="w-full sm:w-auto border-2 border-teal-400 text-teal-400 font-bold px-8 py-3 rounded-full hover:bg-teal-400 hover:text-slate-950 transform hover:scale-105 transition duration-300 focus:ring-4 focus:ring-teal-400/70">
              Get In Touch
            </button>
          </div>

          <div className="flex justify-center md:justify-start gap-6 text-3xl">
            <a href="https://github.com/YeMyatSoe" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white hover:scale-125 transition duration-300"><FaGithub /></a>
            <a href="https://www.linkedin.com/in/yemyat-soe-241775244/" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white hover:scale-125 transition duration-300"><FaLinkedin /></a>
            <a href="mailto:yemyatsoe888@gmail.com" className="text-gray-400 hover:text-white hover:scale-125 transition duration-300"><FaEnvelope /></a>
          </div>
        </div>

        <div className="md:w-1/2 w-full flex justify-center md:justify-end mt-8 md:mt-0 flex-shrink-0">
          <div className="w-64 sm:w-72 md:w-80 h-64 sm:h-72 md:h-80 rounded-full overflow-hidden border-4 border-cyan-500">
            <img
              src="./src/profile.jpg"
              alt="Profile"
      ...
      <ScrollSection id="about" className="p-6 sm:p-10 md:p-20 bg-slate-900 rounded-xl m-4 sm:m-10 md:m-20 shadow-2xl shadow-cyan-500/10">
        ...
        <p className="text-slate-300 text-base sm:text-lg leading-relaxed">
          ...
          I was born on November 1, 1995, and hold a <i>Higher National Diploma (HND)</i> from the University of Greenwich (UK), which I completed in 2022.
          I have a strong interest in creating clean, user-friendly digital experiences using modern web and app technologies. I’m fluent in English across all four skills — reading, writing, listening, and speaking — and enjoy collaborating with others, sharing ideas, and building meaningful projects that help people and businesses grow.
        </p>
      </ScrollSection>
